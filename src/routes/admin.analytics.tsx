...
function AnalyticsPage() {
  ...
  const insights = [
    {
      ...
      tone: "primary",
      title: "AI Insight",
      text: `${d.totalInterns} interns are currently active. Pair high performance engineering interns to expedite sprint tasks.`,
    },
    {
      icon: AlertTriangle,
      tone: "warning",
      title: "Attention",
      text: `There are ${d.pendingTasks} pending tasks in progress across ${d.activeProjects} active assignments.`,
    },
    {
      icon: TrendingUp,
      tone: "success",
      title: "Trending Up",
      text: `Team productivity rate is performing at ${d.productivity}% this sprint.`,
    },
    {
      icon: Target,
      tone: "secondary",
      title: "Attendance",
      text: `Daily attendance index holds high and stable at ${d.attendance}%.`,
    },
  ];
  ...
  return (
    <div>
      <PageHeader
        title="Analytics"
        subtitle="Productivity insights, workload distribution, and AI-generated briefings."
      />

      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        {insights.map((i) => (
          <div key={i.title} className="p-5 rounded-2xl glass shadow-soft">
            <div className={`size-9 rounded-xl grid place-items-center mb-3 ${toneBg[i.tone]}`}>
        ...
        <ResponsiveContainer width="100%" height={240}>
          <LineChart data={trendData}>
            ...
            <Line
              ...
              strokeWidth={3}
              dot={{ r: 4, fill: "oklch(0.74 0.14 210)" }}
            />
          </LineChart>
        </ResponsiveContainer>
      </div>
