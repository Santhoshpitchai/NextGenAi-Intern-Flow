...
function InternCalendarPage() {
  ...
  const getDayEvents = (day: number) => {
    ...
    // Map logged-in intern task deadlines
    tasksList.forEach((t) => {
      if (t.dueDate) {
  ...
  return (
    <div>
      <PageHeader
        title="My Calendar"
        subtitle="Track your task deadlines, project milestones, and sprints."
        actions={
