  ...
  head: () => ({
    meta: [
      { title: "InternFlow AI — Intern Management Platform" },
      {
        name: "description",
        content:
          "Internal platform to manage interns, assign tasks, track progress, and monitor performance.",
      },
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6 text-left">
              ...
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-xl">
                Empower your organization with InternFlow AI—built by{" "}
                <a
                  href="https://www.nextgenaiautomation.net/"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                to streamline task pipelines, track bulletproof attendance, and organize
              ...
              <div className="flex flex-wrap items-center gap-4 pt-2">
                <Button
                  asChild
                  size="lg"
                  className="bg-gradient-primary text-primary-foreground shadow-glow h-12 px-8 font-bold rounded-xl hover:opacity-95 cursor-pointer"
                >
                  <Link to="/login">
              ...
              <div className="border border-border/80 bg-background/80 rounded-2xl shadow-medium overflow-hidden glass p-4 md:p-6 space-y-6">
                ...
                <div className="flex items-center justify-between pb-3 border-b border-border/50">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-mono text-muted-foreground ml-2">
                      internflow_dashboard_v2.tsx
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="px-2 py-0.5 rounded bg-muted text-[9px] font-bold text-muted-foreground uppercase">
                      Active Sprint
                    </span>
                  </div>
                </div>
                ...
                <div className="space-y-2 p-3.5 rounded-xl bg-muted/30 border border-border/40">
                  <div className="flex justify-between items-center text-xs">
                    <span className="font-bold flex items-center gap-1">
                      <Zap className="size-3 text-secondary animate-pulse" /> Platform Velocity
                    </span>
                ...
                <div className="rounded-xl border border-primary/20 bg-card shadow-soft overflow-hidden text-left">
                  ...
                  <div className="p-3 space-y-2 text-xs">
                    <div className="font-extrabold leading-tight text-foreground">
                      Sprint 3 Milestone Reached
                    </div>
                    <p className="text-[11px] text-muted-foreground leading-relaxed">
                      NextGen automation triggers completed. Intern logs verified and compiled into
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
            <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight">
              Standardized Core Ecosystem
            </h2>
            <p className="text-muted-foreground">
              Autonomous tools designed by automation specialists to scale management seamlessly.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((f) => (
              <div
                key={f.title}
                className="p-6 rounded-2xl glass hover:border-primary/30 transition-all duration-300 group hover:-translate-y-1"
              >
                ...
                <h3 className="font-extrabold text-lg mb-2 flex items-center justify-between">
                  ...
                  <Badge
                    variant="secondary"
                    className="text-[8px] bg-primary/10 text-primary uppercase font-black tracking-widest"
                  >
                    {f.badge}
                  </Badge>
                </h3>
      ...
      <section id="about" className="py-24 px-6 bg-card/30 border-y border-border/80 relative">
        ...
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-16 space-y-3">
            ...
            <p className="text-muted-foreground">
              Building high-fidelity applications designed to replace overheads with algorithms.
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="glass p-8 rounded-2xl border border-border/60">
              ...
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
                NextGen AI Automation was founded with a single mission: to bridge the gap between
                cutting-edge artificial intelligence and practical business operations. We build
                internal tools like InternFlow AI to demonstrate how robust task automation,
                attendance check-ins, and conversation loop-mail channels can optimize standard
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="glass p-8 rounded-2xl border border-border/60 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    To help 1,000+ businesses in India automate their repetitive operations, scale
                    administrative pipelines, and unlock breakthrough growth.
                  </p>
                </div>
                <a
                  href="https://www.nextgenaiautomation.net/"
              ...
              <div className="glass p-8 rounded-2xl border border-border/60 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    To become the leading AI automation and internal systems engineering partner for
                    the manufacturing and services sectors by 2030.
                  </p>
                </div>
                <a
                  href="https://www.nextgenaiautomation.net/"
